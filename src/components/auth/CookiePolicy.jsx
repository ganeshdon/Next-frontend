    ...
    <div className="min-h-screen bg-gray-50 py-6 sm:py-8 md:py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 md:p-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6 md:mb-8">Cookie Policy</h1>
          ...
          <div className="prose max-w-none text-gray-700">
            ...
            <section className="mb-6 sm:mb-8">
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">What Are Cookies</h2>
            ...
            <section className="mb-6 sm:mb-8">
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">How We Use Cookies</h2>
              
              <h3 className="text-base sm:text-lg font-medium text-gray-800 mb-2">Essential Cookies</h3>
              <p className="mb-3 sm:mb-4 text-sm sm:text-base">
              ...
              <h3 className="text-base sm:text-lg font-medium text-gray-800 mb-2">Analytics Cookies</h3>
              <p className="mb-3 sm:mb-4 text-sm sm:text-base">
              ...
              <h3 className="text-base sm:text-lg font-medium text-gray-800 mb-2">Functional Cookies</h3>
              <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <section className="mb-6 sm:mb-8">
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Browser Fingerprinting</h2>
              <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <section className="mb-6 sm:mb-8">
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Third-Party Cookies</h2>
              <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <section className="mb-6 sm:mb-8">
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Managing Cookies</h2>
              
              <h3 className="text-base sm:text-lg font-medium text-gray-800 mb-2">Browser Controls</h3>
              <p className="mb-3 sm:mb-4 text-sm sm:text-base">
              ...
              <h3 className="text-base sm:text-lg font-medium text-gray-800 mb-2">Impact of Blocking Cookies</h3>
              <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <section className="mb-6 sm:mb-8">
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Cookie Retention</h2>
              <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <section className="mb-6 sm:mb-8">
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Updates to This Policy</h2>
              <p className="mb-3 sm:mb-4 text-sm sm:text-base">
