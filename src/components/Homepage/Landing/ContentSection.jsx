    ...
    <section className="py-20 bg-slate-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <article className="prose prose-lg max-w-none">
          <div className="bg-white rounded-2xl p-10 shadow-sm mb-8">
          ...
          <div className="bg-white rounded-2xl p-10 shadow-sm mb-8">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-xl font-semibold text-slate-900 mb-2">Create Your Free Account</h4>
                  <p className="text-slate-700 leading-relaxed">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-xl font-semibold text-slate-900 mb-2">Upload Your Statement</h4>
                  <p className="text-slate-700 leading-relaxed">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-xl font-semibold text-slate-900 mb-2">Automatic Data Extraction</h4>
                  <p className="text-slate-700 leading-relaxed">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-xl font-semibold text-slate-900 mb-2">Download in Your Preferred Format</h4>
                  <p className="text-slate-700 leading-relaxed">
          ...
          <div className="bg-white rounded-2xl p-10 shadow-sm">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold text-slate-900 mb-2">Universal Bank Support</h3>
                <p className="text-slate-700 leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-slate-900 mb-2">Multiple Format Support</h3>
                <p className="text-slate-700 leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-slate-900 mb-2">Smart Data Recognition</h3>
                <p className="text-slate-700 leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-slate-900 mb-2">Flexible Plans for Every Need</h3>
                <p className="text-slate-700 leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-slate-900 mb-2">Bulk Processing</h3>
                <p className="text-slate-700 leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-slate-900 mb-2">No Watermarks, Ever</h3>
                <p className="text-slate-700 leading-relaxed">
